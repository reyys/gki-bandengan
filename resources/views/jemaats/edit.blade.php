<x-layout.dashboard>
    <form action={{ route('jemaats.update', compact('jemaat')) }} method="POST" class="w-full max-w-2xl mx-auto"
        enctype="multipart/form-data">
        @csrf
        @method('PUT')
        <div class="space-y-12">
            <div class="border-b pb-12">
                <h2 class="text-base font-semibold leading-7 text-gray-900">Ubah Jemaat</h2>
                <div class="mt-10 grid gap-y-8">
                    <div class="col-span-full">
                        ...
                        <div class="mt-2 w-full">
                            <div
                                ...
                                <input value={{ old('name', $jemaat->name) }} type="text" name="name"
                    ...
                    <div class="col-span-full">
                        ...
                        <input value={{ old('birth_date', $jemaat->birth_date) }} type="date"
                            class="p-2 mt-2 border-gray-300 border w-full rounded-md"
                    ...
                    <div class="col-span-full">
                        ...
                        <div class="mt-2 w-full">
                            <div
                                class="flex rounded-md shadow-sm ring-1 ring-inset ring-gray-300 focus-within:ring-2 focus-within:ring-inset focus-within:ring-indigo-600">
                                <input value={{ old('job', $jemaat->job) }} type="text" name="job" id="job"
                                    autocomplete="job"
                                    class="block flex-1 border-0 bg-transparent py-1.5 pl-3 text-gray-900 placeholder:text-gray-400 focus:ring-0 sm:text-sm sm:leading-6"
